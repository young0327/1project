...
%>
	...
	<div class="humberger__menu__wrapper">
		...
		<br>
		<div class="header__top__right__auth">
			<a href="#" id ="modal-open"><i class="fa fa-user"></i> 강의 수요조사</a>
		</div>
		<br>
		<div class="header__top__right__auth">
...
<div id="container">
	...
	<div class="popup-wrap"">
			...
			<button type = "button" class= "searchLink"><a href="/1GCAP/ogani-master/MainSearchClassList.jsp">관련 강의 보기</a></button>
      		</div>
	</section>
		</div>
	</div>
